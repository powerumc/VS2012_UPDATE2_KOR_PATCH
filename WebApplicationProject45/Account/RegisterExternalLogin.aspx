<%@ Page Language="C#" Title="외부 로그인 등록" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="$safeprojectname$.Account.RegisterExternalLogin" %>
